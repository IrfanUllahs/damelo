              ...
              <div className="row">
                <div className="col-12">
                  <div className="slider-content">
                    <p className="relative z-5 wow fadeInUp">
                      From as low as $10 per day with limited time offer
                      discounts.
                    </p>
                    <h1 className="wow fadeInUp">
                      Your <span>Property</span>, Our Priority.
                    </h1>
                                  ...
                                  <li>
                                    <div className="item1">
                                      <div>
                                        <div className="image">
                                          <img
                                            src="/images/author/avatar-8.png"
                                            alt=""
                                          />
                                        </div>
                                        <p>Archer House</p>
                                  ...
                                  <li>
                                    <div className="item1">
                                      <div>
                                        <div className="image">
                                          <img
                                            src="/images/author/avatar-9.png"
                                            alt=""
                                          />
                                        </div>
                                  ...
                                  <li>
                                    <div className="item1">
                                      <div>
                                        <div className="image">
                                          <img
                                            src="/images/author/avatar-10.png"
                                            alt=""
                                          />
                                        </div>
                    ...
                    <div className="left">
                      ...
                      <div className="wrap-img flex gap10">
                        <div className="flex gap10 flex-column">
                          <img
                            className="img-1"
                            src="/images/image-box/grid-img-1.jpg"
                            alt=""
                          />
                          <img
                            className="img-2"
                            src="/images/image-box/grid-img-2.jpg"
                            alt=""
                          />
                        </div>
                        <div className="flex gap10 flex-column">
                          <img
                            className="img-3"
                            src="/images/image-box/grid-img-3.jpg"
                            alt=""
                          />
                          <img
                            className="img-4"
                            src="/images/image-box/grid-img-4.jpg"
                            alt=""
                          />
                        </div>
                      </div>
                      <div className="box-agents">
                        ...
                        <div className="text">
                          <span>1000K+</span>Exclusive Agetns
                        </div>
                      </div>
                    </div>
                  </div>
