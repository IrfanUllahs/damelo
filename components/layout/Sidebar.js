      ...
      <div className="section-menu-left">
        <div className="menu-content">
          <ul>
            ...
            <li
              className={`${
                pathname === "/dashboard-add-properties" ? "active" : ""
              }`}
            >
            ...
            <li
              className={`${
                pathname === "/dashboard-my-properties" ? "active" : ""
              }`}
            >
            ...
            <li
              className={`${
                pathname === "/dashboard-my-favorites" ? "active" : ""
              }`}
            >
            ...
            <li
              className={`${
                pathname === "/dashboard-saved-search" ? "active" : ""
              }`}
            >
              <Link href="/dashboard-saved-search">
