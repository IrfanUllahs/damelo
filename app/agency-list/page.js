              ...
              <div className="col-lg-4">
                <form className="form-sidebar-left">
                  ...
                  <select className="nice-select" tabIndex={0}>
                    ...
                    <option data-value="Single Family" className="option">
                      Single Family
                    </option>
                  </select>
                  <select className="nice-select" tabIndex={0}>
                    ...
                    <div className="flex gap40">
                      ...
                      <div>
                        <div className="infor">
                          ...
                          <p>
                            Company Agent at{" "}
                            <span>The James Estate Agents</span>
                          </p>
                        </div>
                        <div className="flex gap30 flex-wrap wrap-contact">
                          <Link
                            href="/tel:+68 685 93 283"
                            className="tf-button-icon-before style-1"
                          >
